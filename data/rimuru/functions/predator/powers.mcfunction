...
execute if score @s rimuru_predator_fail matches 1 if score @s[nbt={cardinal_components:{"apoli:powers":{Powers:[{Type:"rimuru:extra_skills_dk",Data:1}]}}}] rimuru_predator_random matches 1 run scoreboard players operation @s rimuru_skill_creative_flight = @s rimuru_switch_temp
