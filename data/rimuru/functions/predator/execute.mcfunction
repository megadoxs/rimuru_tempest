...
execute if score @s rimuru_predator_current_health <= @s rimuru_health run power grant @s rimuru:give_predator_indicator
execute if score @s rimuru_predator_current_health matches ..4 run power grant @s rimuru:give_predator_indicator