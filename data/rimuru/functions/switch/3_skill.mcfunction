...
execute if score @s rimuru_switch_nb matches 0 run resource set @s rimuru:switch_3_skill 1
execute if score @s rimuru_switch_nb matches 1 run resource set @s rimuru:switch_3_skill 2
execute if score @s rimuru_switch_nb matches 2 run resource set @s rimuru:switch_3_skill 3
execute if score @s rimuru_switch_nb matches 3 run resource set @s rimuru:switch_3_skill 4
